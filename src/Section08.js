...
function Section08() {
  const imgs =[
    {image:"section08_p01.png"},
    {image:"section08_p02.png"},
    {image:"section08_p03.png"},
  ]
  return (
    <div className='bg-[#0992A0] w-full  relative '>
      <div className='flex flex-col md:flex-row py-10 md:py-20 items-center justify-between'>
        <div className='md:w-1/2 px-5 md:px-24'>
          <img src={process.env.PUBLIC_URL+'/images/section08_title.png'} alt="" />
          <div className=' pr-8 pt-5'>
            <img src={process.env.PUBLIC_URL+'/images/section08_d01.png'} alt="" />
          </div>
